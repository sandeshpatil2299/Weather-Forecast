...
const WeatherDetails: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const getWeatherData = async () => {
            ...
            setLoading(true);
            const res = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${cityName}&appid=${weatherAPIKey}`);
        ...
        <div className='w-full h-screen bg-slate-700 text-white flex justify-center items-center'>
            {
                loading ? <Loader /> :
                    ...
                    <div className='w-1/2 py-4 flex flex-col justify-center h-full'>
                        ...
                        {/* city name */}
                        <h1 className='text-4xl bg-[#1e293b] w-2/3 mx-auto rounded-md py-3 uppercase font-bold text-center mb-4 shadow-sm'>{cityName}</h1>
